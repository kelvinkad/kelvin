...
netsh interface ipv6 set dns name="Ethernet" static 2a10:50c0::ad1:ff
netsh interface ipv6 add dns name="Ethernet" 2a10:50c0::ad2:ff index=2
netsh interface ip set dns name="Ethernet 2" static 94.140.14.14
netsh interface ip add dns name="Ethernet 2" 94.140.15.15 index=2
netsh interface ipv6 set dns name="Ethernet 2" static 2a10:50c0::ad1:ff
netsh interface ipv6 add dns name="Ethernet 2" 2a10:50c0::ad2:ff index=2
netsh interface ip set dns name="Wi-Fi" static 94.140.14.14
netsh interface ip add dns name="Wi-Fi" 94.140.15.15 index=2
netsh interface ipv6 set dns name="Wi-Fi" static 2a10:50c0::ad1:ff
netsh interface ipv6 add dns name="Wi-Fi" 2a10:50c0::ad2:ff index=2
...
echo -- Google.Chrome Mozilla.Firefox 7zip.7zip RARLab.WinRAR VideoLAN.VLC Adobe.Acrobat.Reader.64-bit
taskkill /f /im explorer.exe && start explorer.exe && start cmd /k "winget install Google.Chrome Mozilla.Firefox 7zip.7zip RARLab.WinRAR VideoLAN.VLC Adobe.Acrobat.Reader.64-bit --accept-source-agreements --accept-package-agreements --force"
:: Pause the script
pause
